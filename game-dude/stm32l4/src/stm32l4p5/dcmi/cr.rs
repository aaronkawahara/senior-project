...
pub struct OELS_R(crate::FieldReader<bool, bool>);
impl OELS_R {
    pub(crate) fn new(bits: bool) -> Self {
        OELS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OELS_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LSM_R(crate::FieldReader<bool, bool>);
impl LSM_R {
    pub(crate) fn new(bits: bool) -> Self {
        LSM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LSM_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OEBS_R(crate::FieldReader<bool, bool>);
impl OEBS_R {
    pub(crate) fn new(bits: bool) -> Self {
        OEBS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OEBS_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct BSM_R(crate::FieldReader<u8, u8>);
impl BSM_R {
    pub(crate) fn new(bits: u8) -> Self {
        BSM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BSM_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
