...
impl core::convert::From<crate::R<AFRH_SPEC>> for R {
...
impl core::convert::From<crate::W<AFRH_SPEC>> for W {
...
pub struct AFRH15_R(crate::FieldReader<u8, AFRH15_A>);
impl AFRH15_R {
...
impl core::ops::Deref for AFRH15_R {
    type Target = crate::FieldReader<u8, AFRH15_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
