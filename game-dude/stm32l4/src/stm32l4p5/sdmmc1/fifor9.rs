...
impl core::convert::From<crate::R<FIFOR9_SPEC>> for R {
    fn from(reader: crate::R<FIFOR9_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FIFOR9` writer"]
...
impl core::convert::From<crate::W<FIFOR9_SPEC>> for W {
...
#[doc = "`read()` method returns [fifor9::R](R) reader structure"]
impl crate::Readable for FIFOR9_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fifor9::W](W) writer structure"]
impl crate::Writable for FIFOR9_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FIFOR9 to value 0"]
