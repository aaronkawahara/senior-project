...
impl core::convert::From<crate::R<FIFOR11_SPEC>> for R {
    fn from(reader: crate::R<FIFOR11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FIFOR11` writer"]
...
impl core::convert::From<crate::W<FIFOR11_SPEC>> for W {
...
#[doc = "`read()` method returns [fifor11::R](R) reader structure"]
impl crate::Readable for FIFOR11_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fifor11::W](W) writer structure"]
impl crate::Writable for FIFOR11_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FIFOR11 to value 0"]
