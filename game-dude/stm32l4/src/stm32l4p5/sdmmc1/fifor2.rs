...
impl core::convert::From<crate::R<FIFOR2_SPEC>> for R {
    fn from(reader: crate::R<FIFOR2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FIFOR2` writer"]
...
impl core::convert::From<crate::W<FIFOR2_SPEC>> for W {
...
#[doc = "`read()` method returns [fifor2::R](R) reader structure"]
impl crate::Readable for FIFOR2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fifor2::W](W) writer structure"]
impl crate::Writable for FIFOR2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FIFOR2 to value 0"]
