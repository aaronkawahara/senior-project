...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn gnptxfsiz_device(&self) -> &crate::Reg<gnptxfsiz_device::GNPTXFSIZ_DEVICE_SPEC> {
        unsafe {
            &*(((self as *const Self) as *const u8).add(40usize)
                as *const crate::Reg<gnptxfsiz_device::GNPTXFSIZ_DEVICE_SPEC>)
        }
    }
}
...
pub mod grxfsiz;
#[doc = "GNPTXFSIZ_Device register accessor: an alias for `Reg<GNPTXFSIZ_DEVICE_SPEC>`"]
