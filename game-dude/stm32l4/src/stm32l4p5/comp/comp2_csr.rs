...
impl core::convert::From<crate::R<COMP2_CSR_SPEC>> for R {
...
impl core::convert::From<crate::W<COMP2_CSR_SPEC>> for W {
...
pub struct COMP2_INPSEL_R(crate::FieldReader<bool, bool>);
impl COMP2_INPSEL_R {
    pub(crate) fn new(bits: bool) -> Self {
