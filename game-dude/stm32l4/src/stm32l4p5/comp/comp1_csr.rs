...
impl core::convert::From<crate::R<COMP1_CSR_SPEC>> for R {
...
impl core::convert::From<crate::W<COMP1_CSR_SPEC>> for W {
...
pub struct COMP1_INPSEL_R(crate::FieldReader<bool, bool>);
impl COMP1_INPSEL_R {
    pub(crate) fn new(bits: bool) -> Self {
