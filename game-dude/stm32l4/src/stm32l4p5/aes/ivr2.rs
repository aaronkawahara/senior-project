...
impl core::convert::From<crate::R<IVR2_SPEC>> for R {
...
impl core::convert::From<crate::W<IVR2_SPEC>> for W {
    fn from(writer: crate::W<IVR2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `IV2` reader - Initialization Vector Register (IVR \\[95:64\\])"]
...
#[doc = "Field `IV2` writer - Initialization Vector Register (IVR \\[95:64\\])"]
pub struct IV2_W<'a> {
    w: &'a mut W,
}
impl<'a> IV2_W<'a> {
