...
impl core::convert::From<crate::R<KEYR2_SPEC>> for R {
...
impl core::convert::From<crate::W<KEYR2_SPEC>> for W {
    fn from(writer: crate::W<KEYR2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `KEY2` reader - AES key register (key \\[95:64\\])"]
...
#[doc = "Field `KEY2` writer - AES key register (key \\[95:64\\])"]
pub struct KEY2_W<'a> {
    w: &'a mut W,
}
impl<'a> KEY2_W<'a> {
