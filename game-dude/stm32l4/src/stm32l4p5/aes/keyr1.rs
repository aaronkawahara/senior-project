...
impl core::convert::From<crate::R<KEYR1_SPEC>> for R {
...
impl core::convert::From<crate::W<KEYR1_SPEC>> for W {
    fn from(writer: crate::W<KEYR1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `KEY1` reader - AES key register (key \\[63:32\\])"]
...
#[doc = "Field `KEY1` writer - AES key register (key \\[63:32\\])"]
pub struct KEY1_W<'a> {
    w: &'a mut W,
}
impl<'a> KEY1_W<'a> {
