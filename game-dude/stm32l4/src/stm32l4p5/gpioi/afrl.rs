...
impl core::convert::From<crate::R<AFRL_SPEC>> for R {
...
impl core::convert::From<crate::W<AFRL_SPEC>> for W {
...
pub struct AFRL7_R(crate::FieldReader<u8, AFRL7_A>);
impl AFRL7_R {
...
impl core::ops::Deref for AFRL7_R {
    type Target = crate::FieldReader<u8, AFRL7_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
