...
pub struct IDR15_R(crate::FieldReader<bool, IDR15_A>);
impl IDR15_R {
...
impl core::ops::Deref for IDR15_R {
    type Target = crate::FieldReader<bool, IDR15_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
