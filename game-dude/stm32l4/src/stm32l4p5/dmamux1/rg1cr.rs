...
impl core::convert::From<crate::R<RG1CR_SPEC>> for R {
...
impl core::convert::From<crate::W<RG1CR_SPEC>> for W {
...
#[doc = "Field `GE` reader - DMA request generator channel 1 enable"]
...
#[doc = "Field `GE` writer - DMA request generator channel 1 enable"]
pub struct GE_W<'a> {
    w: &'a mut W,
}
impl<'a> GE_W<'a> {
...
impl R {
    ...
    #[doc = "Bit 16 - DMA request generator channel 1 enable"]
    #[inline(always)]
    pub fn ge(&self) -> GE_R {
