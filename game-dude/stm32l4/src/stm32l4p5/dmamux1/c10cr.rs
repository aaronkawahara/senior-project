#[doc = "Register `C10CR` reader"]
pub struct R(crate::R<C10CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C10CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<C10CR_SPEC>> for R {
    fn from(reader: crate::R<C10CR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C10CR` writer"]
pub struct W(crate::W<C10CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C10CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<C10CR_SPEC>> for W {
    fn from(writer: crate::W<C10CR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "channel 10 configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c10cr](index.html) module"]
pub struct C10CR_SPEC;
impl crate::RegisterSpec for C10CR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c10cr::R](R) reader structure"]
impl crate::Readable for C10CR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c10cr::W](W) writer structure"]
impl crate::Writable for C10CR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets C10CR to value 0"]
impl crate::Resettable for C10CR_SPEC {
    #[inline(always)]
