...
impl core::convert::From<crate::R<RG2CR_SPEC>> for R {
...
impl core::convert::From<crate::W<RG2CR_SPEC>> for W {
...
#[doc = "Field `GE` reader - DMA request generator channel 2 enable"]
...
#[doc = "Field `GE` writer - DMA request generator channel 2 enable"]
pub struct GE_W<'a> {
    w: &'a mut W,
}
impl<'a> GE_W<'a> {
