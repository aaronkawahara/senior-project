...
pub struct BKER_R(crate::FieldReader<bool, bool>);
impl BKER_R {
    pub(crate) fn new(bits: bool) -> Self {
        BKER_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BKER_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct MER2_R(crate::FieldReader<bool, bool>);
impl MER2_R {
    pub(crate) fn new(bits: bool) -> Self {
        MER2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MER2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
