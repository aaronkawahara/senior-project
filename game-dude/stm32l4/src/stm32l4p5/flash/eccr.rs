...
impl core::convert::From<crate::R<ECCR_SPEC>> for R {
...
impl core::convert::From<crate::W<ECCR_SPEC>> for W {
...
pub struct BK_ECC_R(crate::FieldReader<bool, bool>);
impl BK_ECC_R {
    pub(crate) fn new(bits: bool) -> Self {
        BK_ECC_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BK_ECC_R {
