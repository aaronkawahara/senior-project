...
impl core::convert::From<crate::R<CCMR3_OUTPUT_SPEC>> for R {
...
impl core::convert::From<crate::W<CCMR3_OUTPUT_SPEC>> for W {
    fn from(writer: crate::W<CCMR3_OUTPUT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `OC6M_bit3` reader - Output Compare 6 mode bit 3"]
pub struct OC6M_BIT3_R(crate::FieldReader<bool, bool>);
impl OC6M_BIT3_R {
    pub(crate) fn new(bits: bool) -> Self {
        OC6M_BIT3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OC6M_BIT3_R {
...
pub struct OC5M_BIT3_R(crate::FieldReader<u8, u8>);
impl OC5M_BIT3_R {
    pub(crate) fn new(bits: u8) -> Self {
        OC5M_BIT3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OC5M_BIT3_R {
