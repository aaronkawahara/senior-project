...
impl core::convert::From<crate::R<OR3_SPEC>> for R {
...
impl core::convert::From<crate::W<OR3_SPEC>> for W {
...
pub struct BK2DFBK3E_R(crate::FieldReader<bool, bool>);
impl BK2DFBK3E_R {
    pub(crate) fn new(bits: bool) -> Self {
        BK2DFBK3E_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BK2DFBK3E_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
