...
impl core::convert::From<crate::R<OR1_SPEC>> for R {
...
impl core::convert::From<crate::W<OR1_SPEC>> for W {
    fn from(writer: crate::W<OR1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ETR_ADC2_RMP` reader - External trigger remap on ADC2 analog watchdog"]
pub struct ETR_ADC2_RMP_R(crate::FieldReader<u8, u8>);
impl ETR_ADC2_RMP_R {
    pub(crate) fn new(bits: u8) -> Self {
        ETR_ADC2_RMP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ETR_ADC2_RMP_R {
