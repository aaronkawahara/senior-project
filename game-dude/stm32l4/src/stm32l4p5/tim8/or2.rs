...
impl core::convert::From<crate::R<OR2_SPEC>> for R {
...
impl core::convert::From<crate::W<OR2_SPEC>> for W {
...
pub struct BKDFBK2E_R(crate::FieldReader<bool, bool>);
impl BKDFBK2E_R {
    pub(crate) fn new(bits: bool) -> Self {
        BKDFBK2E_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BKDFBK2E_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
