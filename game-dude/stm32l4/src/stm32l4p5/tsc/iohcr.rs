...
impl core::convert::From<crate::R<IOHCR_SPEC>> for R {
    fn from(reader: crate::R<IOHCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IOHCR` writer"]
...
impl core::convert::From<crate::W<IOHCR_SPEC>> for W {
...
#[doc = "`read()` method returns [iohcr::R](R) reader structure"]
impl crate::Readable for IOHCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [iohcr::W](W) writer structure"]
impl crate::Writable for IOHCR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets IOHCR to value 0xffff_ffff"]
