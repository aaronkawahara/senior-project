...
impl core::convert::From<crate::R<CR5_SPEC>> for R {
...
impl core::convert::From<crate::W<CR5_SPEC>> for W {
...
impl R {
    ...
    pub fn r1mode(&self) -> R1MODE_R {
        R1MODE_R::new(((self.bits >> 8) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 8 - Main regulator Range 1 mode"]
...
#[doc = "`reset()` method sets CR5 to value 0x1000"]
