...
pub struct EWF_R(crate::FieldReader<bool, bool>);
impl EWF_R {
    pub(crate) fn new(bits: bool) -> Self {
        EWF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EWF_R {
