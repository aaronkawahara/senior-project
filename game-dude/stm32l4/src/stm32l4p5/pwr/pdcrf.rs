...
impl core::convert::From<crate::R<PDCRF_SPEC>> for R {
...
impl core::convert::From<crate::W<PDCRF_SPEC>> for W {
    fn from(writer: crate::W<PDCRF_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PD15` reader - Port F pull-down bit y (y=0..15)"]
...
#[doc = "Field `PD15` writer - Port F pull-down bit y (y=0..15)"]
pub struct PD15_W<'a> {
    w: &'a mut W,
}
impl<'a> PD15_W<'a> {
...
#[doc = "Field `PD14` reader - Port F pull-down bit y (y=0..15)"]
...
#[doc = "Field `PD14` writer - Port F pull-down bit y (y=0..15)"]
pub struct PD14_W<'a> {
    w: &'a mut W,
}
impl<'a> PD14_W<'a> {
