...
pub struct ODR15_R(crate::FieldReader<bool, ODR15_A>);
impl ODR15_R {
...
impl core::ops::Deref for ODR15_R {
    type Target = crate::FieldReader<bool, ODR15_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
