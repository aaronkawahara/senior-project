...
impl core::convert::From<crate::R<APB1RSTR1_SPEC>> for R {
...
impl core::convert::From<crate::W<APB1RSTR1_SPEC>> for W {
...
pub struct OPAMPRST_R(crate::FieldReader<bool, bool>);
impl OPAMPRST_R {
    pub(crate) fn new(bits: bool) -> Self {
        OPAMPRST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OPAMPRST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
