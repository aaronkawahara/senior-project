...
impl core::convert::From<crate::R<AHB2ENR_SPEC>> for R {
...
impl core::convert::From<crate::W<AHB2ENR_SPEC>> for W {
...
impl core::ops::Deref for HASHEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OSPIMEN_R(crate::FieldReader<bool, bool>);
impl OSPIMEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        OSPIMEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OSPIMEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn dcmien(&self) -> DCMIEN_R {
        DCMIEN_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    ...
    pub fn ospimen(&self) -> OSPIMEN_R {
        OSPIMEN_R::new(((self.bits >> 20) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 20 - OctoSPI IO manager clock enable"]
    #[inline(always)]
    pub fn ospimen(&mut self) -> OSPIMEN_W {
        OSPIMEN_W { w: self }
    }
    #[doc = "Bit 22 - SDMMC1 clock enable"]
    #[inline(always)]
