...
impl core::convert::From<crate::R<APB1ENR1_SPEC>> for R {
...
impl core::convert::From<crate::W<APB1ENR1_SPEC>> for W {
...
pub struct SP3EN_R(crate::FieldReader<bool, bool>);
impl SP3EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        SP3EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SP3EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
