...
pub struct DFSDM1RST_R(crate::FieldReader<bool, bool>);
impl DFSDM1RST_R {
    pub(crate) fn new(bits: bool) -> Self {
        DFSDM1RST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DFSDM1RST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn dfsdm1rst(&self) -> DFSDM1RST_R {
        DFSDM1RST_R::new(((self.bits >> 24) & 0x01) != 0)
    }
    ...
    pub fn dsirst(&self) -> DSIRST_R {
        DSIRST_R::new(((self.bits >> 27) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - System configuration (SYSCFG) reset"]
