...
impl core::convert::From<crate::R<CIFR_SPEC>> for R {
...
pub struct PLLSAI1RDYF_R(crate::FieldReader<bool, bool>);
impl PLLSAI1RDYF_R {
    pub(crate) fn new(bits: bool) -> Self {
        PLLSAI1RDYF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PLLSAI1RDYF_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct PLLSAI2RDYF_R(crate::FieldReader<bool, bool>);
impl PLLSAI2RDYF_R {
    pub(crate) fn new(bits: bool) -> Self {
        PLLSAI2RDYF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PLLSAI2RDYF_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn pllsai2rdyf(&self) -> PLLSAI2RDYF_R {
        PLLSAI2RDYF_R::new(((self.bits >> 7) & 0x01) != 0)
    }
