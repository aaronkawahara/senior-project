...
impl core::convert::From<crate::R<AHB1SMENR_SPEC>> for R {
...
impl core::convert::From<crate::W<AHB1SMENR_SPEC>> for W {
...
pub struct DMA2DSMEN_R(crate::FieldReader<bool, bool>);
impl DMA2DSMEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        DMA2DSMEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA2DSMEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
