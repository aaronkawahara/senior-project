...
impl core::convert::From<crate::R<AHB1RSTR_SPEC>> for R {
...
impl core::convert::From<crate::W<AHB1RSTR_SPEC>> for W {
...
pub struct DMAMUX1RST_R(crate::FieldReader<bool, bool>);
impl DMAMUX1RST_R {
    pub(crate) fn new(bits: bool) -> Self {
        DMAMUX1RST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMAMUX1RST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
