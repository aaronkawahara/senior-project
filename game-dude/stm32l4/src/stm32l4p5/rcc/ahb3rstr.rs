...
impl core::convert::From<crate::R<AHB3RSTR_SPEC>> for R {
...
impl core::convert::From<crate::W<AHB3RSTR_SPEC>> for W {
...
pub struct OSPI2RST_R(crate::FieldReader<bool, bool>);
impl OSPI2RST_R {
    pub(crate) fn new(bits: bool) -> Self {
        OSPI2RST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OSPI2RST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
