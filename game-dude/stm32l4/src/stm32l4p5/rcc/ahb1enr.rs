...
impl core::convert::From<crate::R<AHB1ENR_SPEC>> for R {
...
impl core::convert::From<crate::W<AHB1ENR_SPEC>> for W {
...
pub struct DMAMUX1EN_R(crate::FieldReader<bool, bool>);
impl DMAMUX1EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        DMAMUX1EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMAMUX1EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DMA2DEN_R(crate::FieldReader<bool, bool>);
impl DMA2DEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        DMA2DEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA2DEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn dma2den(&self) -> DMA2DEN_R {
        DMA2DEN_R::new(((self.bits >> 17) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - DMA1 clock enable"]
