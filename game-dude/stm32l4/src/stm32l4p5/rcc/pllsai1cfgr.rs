...
impl core::convert::From<crate::R<PLLSAI1CFGR_SPEC>> for R {
...
impl core::convert::From<crate::W<PLLSAI1CFGR_SPEC>> for W {
...
pub struct PLLSAI1M_R(crate::FieldReader<u8, u8>);
impl PLLSAI1M_R {
    pub(crate) fn new(bits: u8) -> Self {
        PLLSAI1M_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PLLSAI1M_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
