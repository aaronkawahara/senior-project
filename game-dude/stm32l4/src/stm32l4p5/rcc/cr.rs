...
pub struct PLLSAIRDY_R(crate::FieldReader<bool, bool>);
impl PLLSAIRDY_R {
    pub(crate) fn new(bits: bool) -> Self {
        PLLSAIRDY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PLLSAIRDY_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct PLLSAION_R(crate::FieldReader<bool, bool>);
impl PLLSAION_R {
    pub(crate) fn new(bits: bool) -> Self {
        PLLSAION_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PLLSAION_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
