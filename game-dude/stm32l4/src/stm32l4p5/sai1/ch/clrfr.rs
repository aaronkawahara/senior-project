...
impl core::convert::From<crate::R<CLRFR_SPEC>> for R {
...
pub struct CCNRDY_R(crate::FieldReader<bool, bool>);
impl CCNRDY_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct CWCKCFG_R(crate::FieldReader<bool, bool>);
impl CWCKCFG_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct CMUTEDET_R(crate::FieldReader<bool, bool>);
impl CMUTEDET_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct COVRUDR_R(crate::FieldReader<bool, bool>);
impl COVRUDR_R {
    pub(crate) fn new(bits: bool) -> Self {
