...
impl core::convert::From<crate::R<PUPDR_SPEC>> for R {
...
impl core::convert::From<crate::W<PUPDR_SPEC>> for W {
...
pub struct PUPDR15_R(crate::FieldReader<u8, PUPDR15_A>);
impl PUPDR15_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<PUPDR15_A> {
        match self.bits {
            0 => Some(PUPDR15_A::FLOATING),
            1 => Some(PUPDR15_A::PULLUP),
            2 => Some(PUPDR15_A::PULLDOWN),
            _ => None,
        }
    }
...
impl core::ops::Deref for PUPDR15_R {
    type Target = crate::FieldReader<u8, PUPDR15_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
