...
impl core::convert::From<crate::R<MODER_SPEC>> for R {
...
impl core::convert::From<crate::W<MODER_SPEC>> for W {
...
pub struct MODER15_R(crate::FieldReader<u8, MODER15_A>);
impl MODER15_R {
...
impl core::ops::Deref for MODER15_R {
    type Target = crate::FieldReader<u8, MODER15_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[doc = "`reset()` method sets MODER to value 0xa800_0000"]
