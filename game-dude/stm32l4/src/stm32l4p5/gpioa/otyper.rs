...
impl core::convert::From<crate::R<OTYPER_SPEC>> for R {
...
impl core::convert::From<crate::W<OTYPER_SPEC>> for W {
...
pub struct OT15_R(crate::FieldReader<bool, OT15_A>);
impl OT15_R {
...
impl core::ops::Deref for OT15_R {
    type Target = crate::FieldReader<bool, OT15_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
