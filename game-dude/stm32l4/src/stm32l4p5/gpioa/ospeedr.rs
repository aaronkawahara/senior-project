...
impl core::convert::From<crate::R<OSPEEDR_SPEC>> for R {
...
impl core::convert::From<crate::W<OSPEEDR_SPEC>> for W {
...
pub struct OSPEEDR15_R(crate::FieldReader<u8, OSPEEDR15_A>);
impl OSPEEDR15_R {
...
impl core::ops::Deref for OSPEEDR15_R {
    type Target = crate::FieldReader<u8, OSPEEDR15_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub type OSPEEDR14_R = OSPEEDR15_R;
...
pub type OSPEEDR13_R = OSPEEDR15_R;
...
pub type OSPEEDR12_R = OSPEEDR15_R;
...
pub type OSPEEDR11_R = OSPEEDR15_R;
...
pub type OSPEEDR10_R = OSPEEDR15_R;
...
pub type OSPEEDR9_R = OSPEEDR15_R;
...
pub type OSPEEDR8_R = OSPEEDR15_R;
...
pub type OSPEEDR7_R = OSPEEDR15_R;
...
pub type OSPEEDR6_R = OSPEEDR15_R;
...
pub type OSPEEDR5_R = OSPEEDR15_R;
...
pub type OSPEEDR4_R = OSPEEDR15_R;
...
pub type OSPEEDR3_R = OSPEEDR15_R;
...
pub type OSPEEDR2_R = OSPEEDR15_R;
...
pub type OSPEEDR1_R = OSPEEDR15_R;
...
pub type OSPEEDR0_R = OSPEEDR15_R;
