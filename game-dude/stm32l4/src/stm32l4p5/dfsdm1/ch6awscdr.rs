...
pub struct R(crate::R<CH6AWSCDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH6AWSCDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CH6AWSCDR_SPEC>> for R {
    fn from(reader: crate::R<CH6AWSCDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH6AWSCDR` writer"]
pub struct W(crate::W<CH6AWSCDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH6AWSCDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CH6AWSCDR_SPEC>> for W {
    fn from(writer: crate::W<CH6AWSCDR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CH6AWSCDR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch6awscdr](index.html) module"]
pub struct CH6AWSCDR_SPEC;
impl crate::RegisterSpec for CH6AWSCDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch6awscdr::R](R) reader structure"]
impl crate::Readable for CH6AWSCDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch6awscdr::W](W) writer structure"]
impl crate::Writable for CH6AWSCDR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH6AWSCDR to value 0"]
impl crate::Resettable for CH6AWSCDR_SPEC {
    #[inline(always)]
