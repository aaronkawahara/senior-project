#[doc = "Register `DFSDM_FLT0CR1` reader"]
...
impl core::convert::From<crate::R<DFSDM_FLT0CR1_SPEC>> for R {
    fn from(reader: crate::R<DFSDM_FLT0CR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM_FLT0CR1` writer"]
...
impl core::convert::From<crate::W<DFSDM_FLT0CR1_SPEC>> for W {
...
#[doc = "`read()` method returns [dfsdm_flt0cr1::R](R) reader structure"]
impl crate::Readable for DFSDM_FLT0CR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm_flt0cr1::W](W) writer structure"]
impl crate::Writable for DFSDM_FLT0CR1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DFSDM_FLT0CR1 to value 0"]
