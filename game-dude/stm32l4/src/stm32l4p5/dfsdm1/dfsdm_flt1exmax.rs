#[doc = "Register `DFSDM_FLT1EXMAX` reader"]
...
impl core::convert::From<crate::R<DFSDM_FLT1EXMAX_SPEC>> for R {
...
#[doc = "`read()` method returns [dfsdm_flt1exmax::R](R) reader structure"]
impl crate::Readable for DFSDM_FLT1EXMAX_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DFSDM_FLT1EXMAX to value 0x8000_0000"]
