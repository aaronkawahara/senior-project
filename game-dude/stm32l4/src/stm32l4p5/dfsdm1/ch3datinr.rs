...
pub struct R(crate::R<CH3DATINR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH3DATINR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CH3DATINR_SPEC>> for R {
    fn from(reader: crate::R<CH3DATINR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH3DATINR` writer"]
pub struct W(crate::W<CH3DATINR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH3DATINR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CH3DATINR_SPEC>> for W {
    fn from(writer: crate::W<CH3DATINR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CH3DATINR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch3datinr](index.html) module"]
pub struct CH3DATINR_SPEC;
impl crate::RegisterSpec for CH3DATINR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch3datinr::R](R) reader structure"]
impl crate::Readable for CH3DATINR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch3datinr::W](W) writer structure"]
impl crate::Writable for CH3DATINR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH3DATINR to value 0"]
impl crate::Resettable for CH3DATINR_SPEC {
    #[inline(always)]
