...
pub struct R(crate::R<DFSDM_FLT0RDATAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM_FLT0RDATAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<DFSDM_FLT0RDATAR_SPEC>> for R {
    fn from(reader: crate::R<DFSDM_FLT0RDATAR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "data register for the regular channel\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm_flt0rdatar](index.html) module"]
pub struct DFSDM_FLT0RDATAR_SPEC;
impl crate::RegisterSpec for DFSDM_FLT0RDATAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm_flt0rdatar::R](R) reader structure"]
impl crate::Readable for DFSDM_FLT0RDATAR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DFSDM_FLT0RDATAR to value 0"]
impl crate::Resettable for DFSDM_FLT0RDATAR_SPEC {
    #[inline(always)]
