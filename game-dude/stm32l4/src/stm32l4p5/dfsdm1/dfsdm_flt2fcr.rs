#[doc = "Register `DFSDM_FLT2FCR` reader"]
...
impl core::convert::From<crate::R<DFSDM_FLT2FCR_SPEC>> for R {
    fn from(reader: crate::R<DFSDM_FLT2FCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM_FLT2FCR` writer"]
...
impl core::convert::From<crate::W<DFSDM_FLT2FCR_SPEC>> for W {
...
#[doc = "`read()` method returns [dfsdm_flt2fcr::R](R) reader structure"]
impl crate::Readable for DFSDM_FLT2FCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm_flt2fcr::W](W) writer structure"]
impl crate::Writable for DFSDM_FLT2FCR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DFSDM_FLT2FCR to value 0"]
