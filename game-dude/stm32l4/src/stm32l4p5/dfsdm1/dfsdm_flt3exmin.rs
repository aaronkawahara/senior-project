...
pub struct R(crate::R<DFSDM_FLT3EXMIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM_FLT3EXMIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<DFSDM_FLT3EXMIN_SPEC>> for R {
    fn from(reader: crate::R<DFSDM_FLT3EXMIN_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Extremes detector minimum register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm_flt3exmin](index.html) module"]
