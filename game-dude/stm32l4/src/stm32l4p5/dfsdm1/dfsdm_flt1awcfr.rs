...
pub struct R(crate::R<DFSDM_FLT1AWCFR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM_FLT1AWCFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<DFSDM_FLT1AWCFR_SPEC>> for R {
    fn from(reader: crate::R<DFSDM_FLT1AWCFR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM_FLT1AWCFR` writer"]
pub struct W(crate::W<DFSDM_FLT1AWCFR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM_FLT1AWCFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<DFSDM_FLT1AWCFR_SPEC>> for W {
    fn from(writer: crate::W<DFSDM_FLT1AWCFR_SPEC>) -> Self {
        W(writer)
    }
}
