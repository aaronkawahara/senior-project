...
impl core::convert::From<crate::R<FIFOR13_SPEC>> for R {
    fn from(reader: crate::R<FIFOR13_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FIFOR13` writer"]
...
impl core::convert::From<crate::W<FIFOR13_SPEC>> for W {
...
#[doc = "`read()` method returns [fifor13::R](R) reader structure"]
impl crate::Readable for FIFOR13_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fifor13::W](W) writer structure"]
impl crate::Writable for FIFOR13_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FIFOR13 to value 0"]
