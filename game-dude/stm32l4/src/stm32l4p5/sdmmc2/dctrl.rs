...
impl core::convert::From<crate::R<DCTRL_SPEC>> for R {
...
impl core::convert::From<crate::W<DCTRL_SPEC>> for W {
    fn from(writer: crate::W<DCTRL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `FIFORST` reader - FIFO reset, will flush any remaining data"]
...
#[doc = "Field `FIFORST` writer - FIFO reset, will flush any remaining data"]
...
#[doc = "Field `BOOTACKEN` reader - Enable the reception of the boot acknowledgment"]
...
#[doc = "Field `BOOTACKEN` writer - Enable the reception of the boot acknowledgment"]
...
impl R {
    #[doc = "Bit 13 - FIFO reset, will flush any remaining data"]
    #[inline(always)]
    pub fn fiforst(&self) -> FIFORST_R {
        FIFORST_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    #[doc = "Bit 12 - Enable the reception of the boot acknowledgment"]
    #[inline(always)]
    ...
    #[doc = "Bits 2:3 - Data transfer mode selection 1: Stream or SDIO multibyte data transfer"]
    #[inline(always)]
