#[doc = "Reader of register FIFOR11"]
pub type R = crate::R<u32, super::FIFOR11>;
#[doc = "Writer for register FIFOR11"]
pub type W = crate::W<u32, super::FIFOR11>;
#[doc = "Register FIFOR11 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR11 {
    type Type = u32;
    #[inline(always)]
