#[doc = "Reader of register FIFOR0"]
pub type R = crate::R<u32, super::FIFOR0>;
#[doc = "Writer for register FIFOR0"]
pub type W = crate::W<u32, super::FIFOR0>;
#[doc = "Register FIFOR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR0 {
    type Type = u32;
    #[inline(always)]
