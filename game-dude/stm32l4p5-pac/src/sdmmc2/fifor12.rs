#[doc = "Reader of register FIFOR12"]
pub type R = crate::R<u32, super::FIFOR12>;
#[doc = "Writer for register FIFOR12"]
pub type W = crate::W<u32, super::FIFOR12>;
#[doc = "Register FIFOR12 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR12 {
    type Type = u32;
    #[inline(always)]
