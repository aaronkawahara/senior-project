#[doc = "Reader of register FIFOR15"]
pub type R = crate::R<u32, super::FIFOR15>;
#[doc = "Writer for register FIFOR15"]
pub type W = crate::W<u32, super::FIFOR15>;
#[doc = "Register FIFOR15 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR15 {
    type Type = u32;
    #[inline(always)]
