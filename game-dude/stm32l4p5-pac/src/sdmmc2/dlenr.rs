#[doc = "Reader of register DLENR"]
pub type R = crate::R<u32, super::DLENR>;
#[doc = "Writer for register DLENR"]
pub type W = crate::W<u32, super::DLENR>;
#[doc = "Register DLENR `reset()`'s with value 0"]
impl crate::ResetValue for super::DLENR {
    type Type = u32;
    #[inline(always)]
