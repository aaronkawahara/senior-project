#[doc = "Reader of register FIFOR5"]
pub type R = crate::R<u32, super::FIFOR5>;
#[doc = "Writer for register FIFOR5"]
pub type W = crate::W<u32, super::FIFOR5>;
#[doc = "Register FIFOR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR5 {
    type Type = u32;
    #[inline(always)]
