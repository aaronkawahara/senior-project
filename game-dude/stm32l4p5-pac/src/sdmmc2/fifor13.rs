#[doc = "Reader of register FIFOR13"]
pub type R = crate::R<u32, super::FIFOR13>;
#[doc = "Writer for register FIFOR13"]
pub type W = crate::W<u32, super::FIFOR13>;
#[doc = "Register FIFOR13 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR13 {
    type Type = u32;
    #[inline(always)]
