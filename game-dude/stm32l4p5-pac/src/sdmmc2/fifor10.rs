#[doc = "Reader of register FIFOR10"]
pub type R = crate::R<u32, super::FIFOR10>;
#[doc = "Writer for register FIFOR10"]
pub type W = crate::W<u32, super::FIFOR10>;
#[doc = "Register FIFOR10 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR10 {
    type Type = u32;
    #[inline(always)]
