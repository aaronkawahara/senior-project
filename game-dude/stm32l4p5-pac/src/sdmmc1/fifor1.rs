#[doc = "Reader of register FIFOR1"]
pub type R = crate::R<u32, super::FIFOR1>;
#[doc = "Writer for register FIFOR1"]
pub type W = crate::W<u32, super::FIFOR1>;
#[doc = "Register FIFOR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR1 {
    type Type = u32;
    #[inline(always)]
