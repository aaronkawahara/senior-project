#[doc = "Reader of register FIFOR9"]
pub type R = crate::R<u32, super::FIFOR9>;
#[doc = "Writer for register FIFOR9"]
pub type W = crate::W<u32, super::FIFOR9>;
#[doc = "Register FIFOR9 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR9 {
    type Type = u32;
    #[inline(always)]
