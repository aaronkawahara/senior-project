#[doc = "Reader of register FIFOR2"]
pub type R = crate::R<u32, super::FIFOR2>;
#[doc = "Writer for register FIFOR2"]
pub type W = crate::W<u32, super::FIFOR2>;
#[doc = "Register FIFOR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR2 {
    type Type = u32;
    #[inline(always)]
