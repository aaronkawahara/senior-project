#[doc = "Reader of register FIFOR4"]
pub type R = crate::R<u32, super::FIFOR4>;
#[doc = "Writer for register FIFOR4"]
pub type W = crate::W<u32, super::FIFOR4>;
#[doc = "Register FIFOR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR4 {
    type Type = u32;
    #[inline(always)]
