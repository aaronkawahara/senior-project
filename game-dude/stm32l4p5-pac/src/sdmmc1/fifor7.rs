#[doc = "Reader of register FIFOR7"]
pub type R = crate::R<u32, super::FIFOR7>;
#[doc = "Writer for register FIFOR7"]
pub type W = crate::W<u32, super::FIFOR7>;
#[doc = "Register FIFOR7 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR7 {
    type Type = u32;
    #[inline(always)]
