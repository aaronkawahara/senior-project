#[doc = "Reader of register FIFOR6"]
pub type R = crate::R<u32, super::FIFOR6>;
#[doc = "Writer for register FIFOR6"]
pub type W = crate::W<u32, super::FIFOR6>;
#[doc = "Register FIFOR6 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR6 {
    type Type = u32;
    #[inline(always)]
