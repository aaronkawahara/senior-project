#[doc = "Reader of register FIFOR8"]
pub type R = crate::R<u32, super::FIFOR8>;
#[doc = "Writer for register FIFOR8"]
pub type W = crate::W<u32, super::FIFOR8>;
#[doc = "Register FIFOR8 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR8 {
    type Type = u32;
    #[inline(always)]
