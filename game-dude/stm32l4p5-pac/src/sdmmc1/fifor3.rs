#[doc = "Reader of register FIFOR3"]
pub type R = crate::R<u32, super::FIFOR3>;
#[doc = "Writer for register FIFOR3"]
pub type W = crate::W<u32, super::FIFOR3>;
#[doc = "Register FIFOR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOR3 {
    type Type = u32;
    #[inline(always)]
