...
#[doc = "Reader of field `PLLSAIRDY`"]
pub type PLLSAIRDY_R = crate::R<bool, bool>;
#[doc = "Reader of field `PLLSAION`"]
pub type PLLSAION_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `PLLSAION`"]
