...
impl RegisterBlock {
    ...
    pub fn fltr(&self) -> &FLTR {
        unsafe { &*(((self as *const Self) as *const u8).add(36usize) as *const FLTR) }
    }
    #[doc = "0x24 - FLTR register"]
    #[inline(always)]
    pub fn fltr_mut(&self) -> &mut FLTR {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(36usize) as *mut FLTR) }
    }
    #[doc = "0x24 - Receive data register"]
    #[inline(always)]
    pub fn rxdr(&self) -> &RXDR {
        unsafe { &*(((self as *const Self) as *const u8).add(36usize) as *const RXDR) }
    }
    #[doc = "0x24 - Receive data register"]
    #[inline(always)]
    pub fn rxdr_mut(&self) -> &mut RXDR {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(36usize) as *mut RXDR) }
    }
}
